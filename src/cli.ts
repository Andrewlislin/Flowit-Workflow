...
async function main(): Promise<void> {
  ...
  switch (command) {
    ...
    case 'preset': await runPresetCli(args); return
...
function help(): string { return ['Flowit Workflow', '', 'Commands:', '  flowit-workflow setup [host|all] [--dry-run] [--json]', '  flowit-workflow doctor [host|all] [--json]', '  flowit-workflow repair <host|all> [--dry-run] [--yes]', '  flowit-workflow uninstall <host|all> [--dry-run] [--yes]', '  flowit-workflow preset list', '  flowit-workflow preset show <preset>', '  flowit-workflow preset install <preset> --adapter=<host> --session=all=<sessionId> --dry-run', '  flowit-workflow daemon --adapter=codex --instance=default --detach', '  flowit-workflow daemon --adapter=opencode --adapters=opencode,codex', '  flowit-workflow migrate --instance=default [--legacy-storage=/path/workflow.json ...]', '  flowit-workflow sessions --adapter=workbuddy', '  flowit-workflow bridge-hook workbuddy', '  flowit-workflow bridge-hook doubao-office', '  flowit-workflow ctl --adapter=opencode', '  flowit-workflow claude-hook'].join('\n') }
