...
test('Claude plugin layout declares manifest, lifecycle hooks, trusted prompt hook, MCP server, and adaptive route Skill', async () => {
  ...
  assert.match(route, /Never recurse|Never manufacture/i)
